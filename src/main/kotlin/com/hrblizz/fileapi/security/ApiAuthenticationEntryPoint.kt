...
class ApiAuthenticationEntryPoint : AuthenticationEntryPoint {
    override fun commence(
        ...
        val apiResponseEntity =
            ResponseEntity(null, listOf(ErrorMessage(authEx.message)), HttpStatus.UNAUTHORIZED.value())

        writer.println(JsonUtil.toJson(apiResponseEntity))
        writer.flush()
        writer.close()
    }
}
