...
internal class WebSecurityConfig(
    ...
    override fun configure(http: HttpSecurity) {
        ...
        authorizationConfigurer.antMatchers("/status", "/webjars/**", "/favicon.ico").permitAll().anyRequest()
            .fullyAuthenticated()
    }
}
